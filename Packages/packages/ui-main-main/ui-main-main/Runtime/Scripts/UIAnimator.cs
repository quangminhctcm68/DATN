...
namespace NabaGame.UI
{
    public class UIAnimator
    {
        ...
        private static Vector3 GetTargetPosition(RectTransform target, Vector3 startPosition, Anim animation)
        {
            ...
            {
                case UI.Move.MoveDirection.Left: return new Vector3(-xOffset, startPosition.y, startPosition.z);
                case UI.Move.MoveDirection.Right: return new Vector3(xOffset, startPosition.y, startPosition.z);
                case UI.Move.MoveDirection.Top: return new Vector3(startPosition.x, yOffset, startPosition.z);
                case UI.Move.MoveDirection.Bottom: return new Vector3(startPosition.x, -yOffset, startPosition.z);
                case UI.Move.MoveDirection.TopLeft: return new Vector3(-xOffset, yOffset, startPosition.z);
                case UI.Move.MoveDirection.TopCenter: return new Vector3(0, yOffset, startPosition.z);
                case UI.Move.MoveDirection.TopRight: return new Vector3(xOffset, yOffset, startPosition.z);
                case UI.Move.MoveDirection.MiddleLeft: return new Vector3(-xOffset, 0, startPosition.z);
                case UI.Move.MoveDirection.MiddleCenter: return new Vector3(0, 0, startPosition.z);
                case UI.Move.MoveDirection.MiddleRight: return new Vector3(xOffset, 0, startPosition.z);
                case UI.Move.MoveDirection.BottomLeft: return new Vector3(-xOffset, -yOffset, startPosition.z);
                case UI.Move.MoveDirection.BottomCenter: return new Vector3(0, -yOffset, startPosition.z);
                case UI.Move.MoveDirection.BottomRight: return new Vector3(xOffset, -yOffset, startPosition.z);
                case UI.Move.MoveDirection.CustomPosition: return animation.move.customPosition;
