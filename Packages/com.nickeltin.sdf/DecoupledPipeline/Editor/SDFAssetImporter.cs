...
namespace nickeltin.SDF.Editor.DecoupledPipeline
{
    ...
    public class SDFAssetImporter : ScriptedImporter
    {
        ...
        /// <summary>
        ///  Multiplying version by two for new pipeline
        /// </summary>
        ...
        [SerializeField] internal SDFImportSettings _importSettings;
        [SerializeField] internal LazyLoadReference<Texture> _texture = null;

        public SDFImportSettings ImportSettings
        {
            get => _importSettings;
            set
            {
        ...
        public override void OnImportAsset(AssetImportContext ctx)
        {
            ...
            {
                new PostprocessTextureOverride(), postprocesSpriteStep
            });
        ...
        private static void TryImportTexture(LazyLoadReference<Texture> textureRef, AssetImporter mainImporter,
            AssetImportContext ctx, SDFImportSettings settings, ImportStep[] importSteps)
        {
            ...
            // so its better to ensure dependency 
        ...
        public static List<string> CreateForTextures(IEnumerable<TextureImporter> importers, SDFImportSettings settings)
        {
            return CreateForTextures(importers, new RepeatedEnumerator<SDFImportSettings>(settings));
        }
        
        public static List<string> CreateForTextures(IEnumerable<TextureImporter> importers,
            IEnumerable<SDFImportSettings> settings)
        {
        ...
        /// </returns>
        public static string CreateForTexture(TextureImporter textureImporter, SDFImportSettings settings)
        {
