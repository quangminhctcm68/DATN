...
namespace nickeltin.SDF.Editor
{
    public partial class SDFEditorUtil
    {
        ...
        /// Makes lookup by searching all SDFAsset's in project, then loads its import results artifacts,
        /// and return those SDFAssets that matches provided texture guids. 
        /// </summary>
