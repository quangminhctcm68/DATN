...
namespace nickeltin.SDF.Editor
{
    internal static partial class SDFContextMenus
    {
        ...
        private static void CreateSDFAsset()
        {
            ...
            CreateAssetWithContent.Create($"New SDF Asset.{SDFAssetImporter.EXT}", serializedAsset, null);
        }

        [MenuItem("Tools/nickeltin/SDF/Find all textures with generated SDF")]
