...
namespace nickeltin.SDF.Editor
{
    ...
    internal partial class SDFFLRDebugWindow : EditorWindow, IHasCustomMenu
    {
        ...
        [MenuItem("Tools/nickeltin/SDF/First Layer Renderer Debug")]
                    ...
                    using (new EditorGUI.IndentLevelScope())
                    {
                        foreach (var renderer in sceneRenderers)
                        {
                            ...
                            if (renderer.TryGet(out var rendererInstance))
                            {
                                ...
                                var newHideFlagsValue = (HideFlags)EditorGUILayout.EnumFlagsField(hideFlagsValue, GUILayout.ExpandWidth(false));
