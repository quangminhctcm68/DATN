...
namespace nickeltin.SDF.Editor
{
    ...
    internal class SDFImportContext
    {
        ...
        public SDFImportContext(TextureImporter textureImporter, SDFImportSettings importSettings, AssetImporter mainAssetImporter)
        {
        ...
        public SDFImportSettings ImportSettings { get; set; }
        
        public SDFGenerationBackend.Context Backend { get; set; }
