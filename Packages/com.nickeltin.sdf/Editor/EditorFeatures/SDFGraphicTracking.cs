...
{
    /// <summary>
    /// Handles sdf graphic refresh when sdf assets they using is re-imported.
    /// Covers case when sdf graphic in scene is not immediately updated after sdf re-imported, for some reason...
    /// </summary>
