...
namespace nickeltin.SDF.Editor
{
    ...
    internal static class SDFDragAndDrop
    {
        ...
        public static void HandleDragAndDrop(SerializedProperty property, bool isDragging, bool isDropping)
        {
            ...
            switch (dragObj)
            {
                ...
                case Texture:
                    ...
                    // If not dropping don't load the sprite but change visual mode.
                    if (!isDropping)
                    {
                        DragAndDrop.visualMode = DragAndDropVisualMode.Generic;
                        return;
            ...
            void AcceptDrag(Sprite sprite, string lPath)
            {
                ...
                else
                {
                    ...
                    // Setting null to clear value that might be missing
        ...
        /// <summary>
        /// This is highly unoptimized version to handle dragNDrop for all possible cases for collection of objects.
        ...
        public static bool HandleListDragAndDrop(SerializedProperty property, bool isDragging, bool isDropping, bool searchForSDFAsset)
        {
            ...
            // Meta assets can be easily extracted from SDFAsset, so no search just add them directly
            ...
            SDFSpriteMetadataAsset[] assets)
        {
            ...
            if (perform)
            {
                foreach (var sdfAsset in assets)
                {
                    ...
                    EditorExtension.PlaceUIElementRoot(go, new MenuCommand(lParent));
                }
            }
