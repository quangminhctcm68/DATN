...
namespace nickeltin.SDF.Editor
{
    internal abstract class SDFGraphicsEditor : GraphicEditor
    {
        ...
        {
            isExpanded.isExpanded = DrawFoldout(isExpanded.isExpanded, title);
        ...
        protected static bool DrawFoldout(bool isExpanded, string title)
        {
            ...
            return EditorGUI.Toggle(rect, GUIContent.none, isExpanded, EditorStyles.foldout);
        }
    }
}